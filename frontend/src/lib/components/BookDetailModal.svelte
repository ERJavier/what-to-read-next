...
>
	<!-- Modal Content -->
	<div
		class="bg-academia-light rounded-lg shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-academia-lighter"
	...
	>
		...
		<div class="p-6 md:p-8">
			...
			{:else if book}
				...
				<div class="mt-8 pt-6 border-t border-academia-lighter">
					<h2 class="text-xl font-semibold text-academia-cream/80 mb-4">
						Related Books
					</h2>
